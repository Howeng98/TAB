...
# check latest weights for each model
model_urls = {
    'resnet18': 'https://download.pytorch.org/models/resnet18-f37072fd.pth',
    'resnet34': 'https://download.pytorch.org/models/resnet34-b627a593.pth',
    'resnet50': 'https://download.pytorch.org/models/resnet50-11ad3fa6.pth', 
    #original: https://download.pytorch.org/models/resnet50-0676ba61.pth
    ...
    # original: https://download.pytorch.org/models/wide_resnet50_2-95faca4d.pth
    'wide_resnet101_2': 'https://download.pytorch.org/models/wide_resnet101_2-d733dc28.pth', 
    # original: https://download.pytorch.org/models/wide_resnet101_2-32ee1156.pth
}
...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor):
        ...
        feature_a = self.layer1(x)          # 64*56*56
        feature_b = self.layer2(feature_a)  # 128*28*28
        feature_c = self.layer3(feature_b)  # 256*14*14
        feature_d = self.layer4(feature_c)  # 512*7*7
        feature_d = self.avgpool(feature_d).squeeze()
