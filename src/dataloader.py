    ...
    def __getitem__(self, idx):
        ...
        if self.is_train:
            ...
            if torch.rand(1).numpy()[0] > 0.5:
                augmented_image, augmented_mask = patch_ex(ima_dest=np.asarray(image), ima_src=np.asarray(ano_image), **self.self_sup_args)            
                ...
                # abnormal label
                class_label = class_label + len(self.CLASS_NAMES)
            ...
            return image, mask, class_name, class_label
